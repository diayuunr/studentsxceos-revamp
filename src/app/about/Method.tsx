...
export default function Method() {
  return (
    <section className="w-full px-6 md:px-16 py-20 md:py-27 text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-4xl mx-auto">
        {methodology.map((method, i) => (
          <div key={i} className="border border-[var(--color-neutral-200)] rounded-xl p-3 text-center shadow-sm">
            <div className="relative w-full h-45 mb-3 overflow-hidden rounded-lg bg-gradient-to-b from-[var(--neutral-900)] to-[var(--primary-500)]">
            <Image 
              src={method.image} 
              alt={method.title} 
            ...
            <p className="text-sm md:text-base font-normal max-w-md tracking-wide px-4 mb-3">{method.description}</p>
          </div>
        ))}
      </div>
    </section>
