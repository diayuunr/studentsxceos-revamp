...
export default function Vision() {
    ...
    const icon = "flex items-center justify-center my-auto w-6 h-6 p-1 rounded-md bg-gradient-to-b from-[var(--neutral-900)] to-[var(--primary-600)] text-white"
    const missionList = [
  ...
  return (
    <section className="w-full px-6 md:px-16 py-20 md:py-23 text-center">
        <div className="relative p-[2px] rounded-[22px] bg-gradient-to-b from-[var(--neutral-900)] to-[var(--primary-600)] backdrop-blur-md w-full">
            <div className="relative justify-center h-full p-15 max-w-3xl mx-auto">
            <h1 className="text-xl md:text-3xl font-bold mb-6 text-[var(--color-white)]">Our Vision</h1>
            <p className="text-sm md:text-lg max-w-5xl mx-auto font-medium text-[var(--color-white)]">
            ...
            <div className="relative justify-center h-full gap-5 p-15 max-w-6xl mx-auto">
            <h1 className="text-xl md:text-3xl font-bold mb-6 text-[var(--color-white)]">Our Mission</h1>
