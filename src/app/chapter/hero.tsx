...
export default function Hero({ title, subtitle, bgImage }: HeroProps) {
  ...
  return (
    <section className="relative w-full h-[60vh] md:h-[55vh] flex flex-col items-center justify-center overflow-hidden">
      ...
      >
        <h1 className="text-[22px] sm:text-[30px] md:text-[32px] font-medium text-white mb-2 tracking-wide glow-text leading-snug md:leading-normal max-w-[340px] md:max-w-[640px] mx-auto">
