...
export default function Contact() {
  const socialMedia = [
    { name: 'Instagram', icon: 'M7.75 2C4.57 2 2 4.57 2 7.75v8.5C2 19.43 4.57 22 7.75 22h8.5C19.43 22 22 19.43 22 16.25v-8.5C22 4.57 19.43 2 16.25 2h-8.5zm0 2h8.5C18.32 4 20 5.68 20 7.75v8.5C20 18.32 18.32 20 16.25 20h-8.5C5.68 20 4 18.32 4 16.25v-8.5C4 5.68 5.68 4 7.75 4zm4.25 3a5 5 0 100 10 5 5 0 000-10zm0 2a3 3 0 110 6 3 3 0 010-6zm4.5-.88a1.12 1.12 0 100 2.24 1.12 1.12 0 000-2.24z' },
    { name: 'LinkedIn', icon: 'M4.98 3.5C4.98 4.88 3.87 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1s2.48 1.12 2.48 2.5zM0 8h5v16H0V8zm7.5 0h4.78v2.18h.07c.66-1.25 2.28-2.57 4.69-2.57C21.42 7.61 24 10.09 24 14.28V24h-5v-8.43c0-2.01-.04-4.59-2.8-4.59-2.8 0-3.23 2.18-3.23 4.44V24h-5V8z' },
    { name: 'TikTok', icon: 'M21 8.5a7.5 7.5 0 01-4.5-1.5V16a6 6 0 11-6-6c.34 0 .67.03 1 .08v3.03a3 3 0 10 3 2.89V2h3a4.5 4.5 0 003.5 3.5v3z' },
  ];
