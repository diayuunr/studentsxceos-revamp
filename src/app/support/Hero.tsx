  ...
  return (
    <section className="relative w-full h-[47vh] md:h-[55vh] px-6 md:px-16 py-20 md:py-15 text-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-white">
        <h1 className="text-2xl md:text-3xl font-medium mt-20 md:mt-40 glow-text tracking-wide">Support Our Mission</h1>
        <p className="text-sm md:text-lg md:max-w-2xl md:text-center mx-auto font-light mt-4 tracking-wider">
