...
export default function Speakers() {
  ...
  const visibleSpeakers = expanded ? speakers : speakers.slice(0, isMobile ? 4 : 8);

  return (
    <section className="w-full px-5 md:px-16 py-5 mb-10 md:py-10 text-center">
      ...
      >
        Some of the distinguished leaders who have shared their insights with us
      </motion.p>
