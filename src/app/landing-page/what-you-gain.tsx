  ...
  const cards = [
    {
      ...
      desc: <>Participants gain exposure to <span className="font-semibold text-slate-900">real-world challenges</span> and learn how leaders navigate complex situations.</>,
      icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2",
    },
    {
      title: "Professional Networking Events",
      desc: <>Exclusive events that connect students with <span className="font-semibold text-slate-900">leaders, alumni, and peers</span> — creating open doors to <span className="font-semibold text-slate-900">future opportunities.</span></>,
      icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z",
    },
    {
      title: "Corporate Mentorship Opportunities",
      desc: <>Access to experienced professionals and executives who share practical <span className="font-semibold text-slate-900">insights and career guidance.</span></>,
      icon: "M13 10V3L4 14h7v7l9-11h-7z",
    },
    {
      title: "Skill-Building Workshops",
      desc: <><span className="font-semibold text-slate-900">Hands-on workshops</span> focused on practical competencies such as communication, problem-solving, and critical thinking.</>,
