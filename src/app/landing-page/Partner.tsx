  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        >
          <h3 className="hidden md:block text-2xl md:text-[32px] font-medium mb-3 text-black tracking-wide">
            Partner with Us
          </h3>

          <p className="text-gray-600 leading-relaxed font-normal text-md text-[16px] md:text-[18px] md:w-6/7">
