...
export default function Lead() {
  ...
  return (
    <section
      id="about"
      className="ml-4 md:ml-0 mx-auto max-w-full px-2 md:px-10 text-black overflow-x-hidden"
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        <div className="flex flex-col md:flex-row justify-content h-full gap-10 p-15">
            <motion.div
              className="w-full relative aspect-[5/4] md:aspect-[9/5] scale-120"
        ...
        <motion.div {...fadeInUp} className="text-center md:text-left">
          <h3 className="text-[26px] md:text-[30px] font-medium mb-3 text-black tracking-wide">
          ...
          >
            ...
            <motion.button
              ...
              className="relative cursor-pointer mt-6 mb-6 bg-linear-to-br from-[#121926] to-[#0A3C8E] overflow-hidden py-2 px-5 rounded-lg text-base z-0 border border-black"
            >
              <motion.div
                variants={{
                  initial: { scaleX: 0 },
              ...
              >
                Explore Chapters <ArrowRight size={23} className="ml-2" />
              </motion.span>
            </motion.button>
            </Link>
          </motion.div>
